# FuseSoC Prebuilt IOb-UART16550 Core Repository

This repository contains a prebuilt version of the [iob\_uart16550](https://github.com/IObundle/iob-uart16550) core, exported and packaged to be FuseSoC-compatible.
...
The prebuilt sources of this repository were taken from the latest release assets of the iob\_uart16550 project: https://github.com/IObundle/iob-uart16550/releases/latest
...
```bash
fusesoc library add <library_name> https://github.com/IObundle/iob-uart16550.git
```
